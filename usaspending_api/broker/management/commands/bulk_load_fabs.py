...
class Command(BaseCommand):
    ...
    def diff_fabs_data(self, db_cursor, ds_cursor, fiscal_year=None):
        ...
        ds_query = "SELECT published_award_financial_assistance_id " "FROM transaction_fabs"
        ds_arguments = []
    ...
    def load_transaction_normalized(self, fabs_broker_data, total_rows):
        ...
        for index, row in enumerate(fabs_broker_data, 1):
            ...
            fad_field_map = {"type": "assistance_type", "description": "award_description"}
    ...
    def load_transaction_fabs(self, fabs_broker_data, total_rows):
        ...
        for index, row in enumerate(fabs_broker_data, 1):
            ...
            fabs_instance_data = load_data_into_model(TransactionFABS(), row, as_dict=True)  # thrown away
    ...
    def delete_stale_fabs(self, to_delete=None):
        ...
        TransactionNormalized.objects.filter(
            assistance_data__published_award_financial_assistance_id__in=to_delete
        ).delete()
