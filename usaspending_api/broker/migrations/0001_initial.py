...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"db_table": "external_data_load_date", "managed": True},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "external_data_type", "managed": True},
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name="externaldataloaddate", unique_together=set([("last_load_date", "external_data_type")])
        ),
    ]
