...
def get_business_categories(row, data_type):
    ...
    if data_type == "fabs":
        ...
        if (
            legal_entity_bool_dict["nonprofit_organization"] is True
            or legal_entity_bool_dict["other_not_for_profit_organ"] is True
        ...
        if (
            legal_entity_bool_dict["state_controlled_instituti"] is True
        ...
        if (
            legal_entity_bool_dict["minority_institution"] is True
        ...
        # GOVERNMENT
        if (
            legal_entity_bool_dict["us_federal_government"] is True
        ...
        if (
            legal_entity_bool_dict["city_local_government"] is True
        ...
        if (
            legal_entity_bool_dict["us_tribal_government"] is True
            or legal_entity_bool_dict["indian_tribe_federally_rec"] is True
        ):
            business_category_set.add("indian_native_american_tribal_government")

        if (
            legal_entity_bool_dict["housing_authorities_public"] is True
