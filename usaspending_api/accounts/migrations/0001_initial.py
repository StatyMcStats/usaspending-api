...
class Migration(migrations.Migration):
    ...
    dependencies = [("submissions", "0001_initial"), ("references", "0001_initial")]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"db_table": "appropriation_account_balances", "managed": True},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "appropriation_account_balances_quarterly", "managed": True},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "budget_authority"},
        ),
        migrations.CreateModel(
            name="FederalAccount",
            fields=[
            ...
            options={"db_table": "federal_account", "managed": True},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "federal_account",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="accounts.FederalAccount"
                    ),
                ),
                (
            ...
            options={"db_table": "treasury_appropriation_account", "managed": True},
        ),
        migrations.AlterUniqueTogether(
            name="federalaccount", unique_together=set([("agency_identifier", "main_account_code")])
        ),
        migrations.AlterUniqueTogether(
            name="budgetauthority", unique_together=set([("agency_identifier", "fr_entity_code", "year")])
        ),
        migrations.AddField(
            model_name="appropriationaccountbalancesquarterly",
            name="treasury_account_identifier",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="accounts.TreasuryAppropriationAccount"
            ),
        ),
        migrations.AddField(
