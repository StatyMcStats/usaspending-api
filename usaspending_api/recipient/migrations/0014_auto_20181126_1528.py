...
class Migration(migrations.Migration):
    ...
    dependencies = [("recipient", "0013_entity structure to duns")]

    operations = [
        migrations.AlterField(
            model_name="historicparentduns", name="awardee_or_recipient_uniqu", field=models.TextField()
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name="historicparentduns", name="legal_business_name", field=models.TextField(blank=True, null=True)
        ),
        migrations.AlterField(
            model_name="historicparentduns",
        ...
        migrations.AlterField(
            model_name="historicparentduns", name="year", field=models.IntegerField(blank=True, null=True)
        ),
        migrations.AlterField(
            model_name="recipientlookup", name="duns", field=models.TextField(null=True, unique=True)
        ),
        migrations.AlterField(
        ...
        migrations.AlterUniqueTogether(
            name="recipientprofile", unique_together=set([("recipient_hash", "recipient_level")])
        ),
        migrations.AddIndex(
