...
class Migration(migrations.Migration):
    ...
    dependencies = [("references", "0005_auto_20171201_1603")]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name="location", name="zip4", field=models.TextField(blank=True, null=True, verbose_name="ZIP+4")
        ),
        migrations.AlterField(model_name="location", name="zip5", field=models.TextField(blank=True, null=True)),
        migrations.AlterField(model_name="location", name="zip_4a", field=models.TextField(blank=True, null=True)),
        migrations.AlterField(model_name="location", name="zip_last4", field=models.TextField(blank=True, null=True)),
    ]
