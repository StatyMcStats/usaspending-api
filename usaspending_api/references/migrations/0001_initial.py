...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"db_table": "agency", "managed": True},
        ),
        migrations.CreateModel(
            name="Cfda",
            fields=[
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        blank=True, null=True, verbose_name="JSON of Filter"
                    ),
                ),
                ("hash", models.TextField(unique=True, verbose_name="Hash of JSON Filter")),
            ],
            options={"db_table": "filter_hash", "managed": True},
        ),
        migrations.CreateModel(
            name="FrecMap",
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(blank=True, null=True, verbose_name="Parent DUNS Number"),
                ),
                ...
                (
                    "recipient_unique_id",
                    models.TextField(blank=True, db_index=True, null=True, verbose_name="DUNS Number"),
                ),
                ...
                (
                    ...
                    models.TextField(blank=True, null=True, verbose_name="Alaskan Native Owned Servicing Institution"),
                ),
                ...
                (
                    ...
                    models.TextField(blank=True, null=True, verbose_name="American Indian Owned Business"),
                ),
                (
                    "alaskan_native_owned_corporation_or_firm",
                    models.TextField(blank=True, null=True, verbose_name="Alaskan Native Owned Corporation or Firm"),
                ),
                ...
                (
                    ...
                    models.TextField(blank=True, null=True, verbose_name="Asian Pacific American Owned business"),
                ),
            ...
            options={"db_table": "legal_entity", "managed": True},
        ),
        migrations.CreateModel(
            name="Location",
            fields=[
                ...
                (
                    "address_line1",
                    models.TextField(blank=True, db_index=True, null=True, verbose_name="Address Line 1"),
                ),
                (
                    "address_line2",
                    models.TextField(blank=True, db_index=True, null=True, verbose_name="Address Line 2"),
                ),
                (
                    "address_line3",
                    models.TextField(blank=True, db_index=True, null=True, verbose_name="Address Line 3"),
                ),
                ...
                (
                    "congressional_code",
                    models.TextField(blank=True, db_index=True, null=True, verbose_name="Congressional District Code"),
                ),
                (
                    "performance_code",
                    models.TextField(blank=True, null=True, verbose_name="Primary Place Of Performance Location Code"),
                ),
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="Location used as place of performance"),
                ),
                (
                    "recipient_flag",
                    models.BooleanField(default=False, verbose_name="Location used as recipient location"),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            options={"db_table": "object_class", "managed": True},
        ),
        migrations.CreateModel(
            name="OfficeAgency",
            fields=[
            ...
            options={"db_table": "office_agency", "managed": True},
        ),
        migrations.CreateModel(
            name="OverallTotals",
            fields=[
            ...
            options={"db_table": "overall_totals", "managed": True},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "ref_city_county_code", "managed": True},
        ),
        migrations.CreateModel(
            name="RefCountryCode",
            fields=[
            ...
            options={"db_table": "ref_country_code", "managed": True},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "ref_program_activity", "managed": True},
        ),
        migrations.CreateModel(
            name="SubtierAgency",
            fields=[
            ...
            options={"db_table": "subtier_agency", "managed": True},
        ),
        migrations.CreateModel(
            name="ToptierAgency",
            fields=[
                ...
                (
                    "cgac_code",
                    models.TextField(blank=True, db_index=True, null=True, verbose_name="Top-Tier Agency Code"),
                ),
                ...
                (
                    "icon_filename",
                    models.TextField(blank=True, null=True, verbose_name="Top-Tier Agency Icon Filename"),
                ),
            ],
            options={"db_table": "toptier_agency", "managed": True},
        ),
        migrations.CreateModel(
        ...
        migrations.AlterUniqueTogether(
            name="objectclass", unique_together=set([("object_class", "direct_reimbursable")])
        ),
        migrations.AddField(
            model_name="location",
        ...
        migrations.AddField(
            ...
            name="office_agency",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="references.OfficeAgency"
            ),
        ),
        migrations.AddField(
            model_name="agency",
        ...
        migrations.AlterUniqueTogether(
            name="agency", unique_together=set([("toptier_agency", "subtier_agency", "office_agency")])
        ),
        TrigramExtension(),
    ]
