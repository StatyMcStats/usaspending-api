...
class Migration(migrations.Migration):
    ...
    dependencies = [("references", "0016_create_gtas_total_obligation_table"), ("awards", "0030_merge_20180517_1646")]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, primary_key=True, to="awards.Award"
                    ),
                ),
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, primary_key=True, to="references.Location"
                    ),
                ),
                (
                    "recipient",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, primary_key=True, to="references.LegalEntity"
                    ),
                ),
            ...
            options={"db_table": "subaward_view", "managed": False},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "summary_state_view", "managed": False},
        ),
    ]
