    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        db_index=True,
                        help_text="The mechanism used to distribute funding. The federal government can distribute funding in several forms. These award types include contracts, grants, loans, and direct payments.",
                        null=True,
                ...
                (
                    "category",
                    models.TextField(
                        help_text="A field that generalizes the award's type.", null=True, verbose_name="Category"
                    ),
                ),
                (
                    "piid",
                    models.TextField(
                        blank=True,
                        db_index=True,
                        help_text="Procurement Instrument Identifier - A unique identifier assigned to a federal contract, purchase order, basic ordering agreement, basic agreement, and blanket purchase agreement. It is used to track the contract, and any modifications or transactions related to it. After October 2017, it is between 13 and 17 digits, both letters and numbers.",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    "date_signed",
                    models.DateField(
                        db_index=True, help_text="The date the award was signed", null=True, verbose_name="Award Date"
                    ),
                ),
                (
                    "description",
                ...
                (
                    "last_modified_date",
                    models.DateField(blank=True, help_text="The date this award was last modified", null=True),
                ),
                (
                    "certified_date",
                    models.DateField(blank=True, help_text="The date this record was certified", null=True),
                ),
                (
                    "create_date",
                    models.DateTimeField(
                        auto_now_add=True, help_text="The date this record was created in the API", null=True
                    ),
                ),
                (
                    "update_date",
                    models.DateTimeField(
                        auto_now=True, help_text="The last time this record was updated in the API", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "object_class",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="references.ObjectClass"
                    ),
                ),
                (
                    "program_activity",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="references.RefProgramActivity"
                    ),
                ),
                (
                    "submission",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="submissions.SubmissionAttributes"
                    ),
                ),
                (
                    "treasury_account",
            ...
            options={"db_table": "financial_accounts_by_awards", "managed": True},
        ),
        migrations.CreateModel(
            name="Subaward",
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Specified which industry the work for this transaction falls into. A 6-digit code",
                        null=True,
                        verbose_name="NAICS",
                    ),
                ),
                ...
                (
                    "award",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="subawards", to="awards.Award"
                    ),
                ),
                (
                    "awarding_agency",
                    models.ForeignKey(
                        ...
                        related_name="awarding_subawards",
                        to="references.Agency",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="related_subawards",
                        to="references.Cfda",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="funding_subawards",
                        to="references.Agency",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="references.Location"
                    ),
                ),
                (
                    "recipient",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="references.LegalEntity"),
                ),
                (
                    "submission",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="If this record is legacy USASpending data, this is the unique transaction identifier from that system",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    "action_type",
                    models.TextField(
                        blank=True, help_text="The type of transaction. For example, A, B, C, D", null=True
                    ),
                ),
                ...
                (
                    "last_modified_date",
                    models.DateField(blank=True, help_text="The date this transaction was last modified", null=True),
                ),
                (
                    "certified_date",
                    models.DateField(blank=True, help_text="The date this transaction was certified", null=True),
                ),
                (
                    "create_date",
                    models.DateTimeField(
                        auto_now_add=True, help_text="The date this transaction was created in the API", null=True
                    ),
                ),
                (
                    "update_date",
                    models.DateTimeField(
                        auto_now=True, help_text="The last time this transaction was updated in the API", null=True
                    ),
                ),
                (
                    "fiscal_year",
                    models.IntegerField(blank=True, help_text="Fiscal Year calculated based on Action Date", null=True),
                ),
            ],
            options={"db_table": "transaction_normalized"},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(blank=True, decimal_places=2, max_digits=23, null=True),
                ),
                ("fain", models.TextField(blank=True, null=True)),
                (
                    "federal_action_obligation",
            ...
            options={"db_table": "transaction_fabs"},
        ),
        migrations.CreateModel(
            ...
            options={"db_table": "transaction_fpds"},
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="awards_transactionnormalized_funding_agency",
                to="references.Agency",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="recipient",
            field=models.ForeignKey(
                help_text="The recipient for this transaction",
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to="references.LegalEntity",
            ),
        ),
        migrations.AddField(
            model_name="award",
        ...
        migrations.AddField(
            ...
            name="place_of_performance",
            field=models.ForeignKey(
                help_text="The principal place of business, where the majority of the work is performed. For example, in a manufacturing contract, this would be the main plant where items are produced.",
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to="references.Location",
            ),
        ...
        migrations.AddField(
            ...
            name="recipient",
            field=models.ForeignKey(
                help_text="The recipient of the award",
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to="references.LegalEntity",
            ),
        ),
        migrations.AlterIndexTogether(name="transactionnormalized", index_together=set([("award", "action_date")])),
        migrations.AlterUniqueTogether(
            name="transactionfabs",
            unique_together=set([("awarding_sub_tier_agency_c", "award_modification_amendme", "fain", "uri")]),
        ),
        migrations.AlterUniqueTogether(name="subaward", unique_together=set([("subaward_number", "award")])),
    ]
