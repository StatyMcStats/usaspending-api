...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "/api/v1/awards/",
            {"filters": [{"field": "date_signed", "operation": "greater_than_or_equal", "value": "2016-06-01"}]},
        ),
        (
            "/api/v1/awards/",
            {
                "filters": [
                    {"field": "date_signed", "operation": "greater_than_or_equal", "value": "2016-06-01"},
                    {"field": "date_signed", "operation": "less_than", "value": "2017-06-01"},
                ]
            },
        ),
        (
        ...
        (
            ...
            {
                "filters": [
                    {"field": "recipient__recipient_name", "operation": "equals", "value": "GENERAL ELECTRIC COMPANY"}
                ]
            },
        ),
        ...
        (
            ...
            {
                "fields": ["type"],
                "filters": [{"field": "date_signed", "operation": "greater_than", "value": "2016-06-01"}],
            },
        ),
        ...
        (
            "/api/v1/awards/total/",
            {"field": "total_obligation", "group": "date_signed", "aggregate": "count", "date_part": "month"},
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "/api/v1/awards/",
            {"filters": [{"field": "latest_transaction__contract_data", "operation": "is_null", "value": False}]},
        ),
        (
            "/api/v1/awards/",
            {"filters": [{"field": "place_of_performance__state_code", "operation": "not_equals", "value": "NJ"}]},
        ),
    ],
)
@pytest.mark.django_db
